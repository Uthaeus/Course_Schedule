  ...
  return {
    ...
    payload: [
      ...
      },
      {
        ...
        'description': 'In this course you\'ll take a practical look at how to build a large numnber of software applications and features. By taking a systems analysis and design approach to development and leveraging UML, you\'ll be able to model systems and prepare to build the projects.',
        'enrolled': false,
        'open': false 
      },
      {
